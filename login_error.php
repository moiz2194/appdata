...
<img class="concord-img vlv-creative" 
	...
	<div class=" default-ltr-cache-zuk9fp e191g6e33" role="alert" data-uia="error-message-container">
  <div class="default-ltr-cache-1x17g94 e191g6e32">
<div class="default-ltr-cache-mkkf9p e191g6e31">
    <div data-uia="error-message-container+header" class="default-ltr-cache-1g4mhl1 e191g6e30">
        <?php echo $translations['errorMessage']; ?>
    </div>
    <?php echo $translations['youCanText']; ?> <button class="pressable_styles__a6ynkg0 anchor_styles__1h0vwqc0  default-ltr-cache-1o3taxu e1gz2xdw0" dir="ltr" role="link" type="button"><?php echo $translations['signInCodeButton']; ?></button>, <a class="" target="_self" href="#"><?php echo $translations['resetYourPasswordLink']; ?></a> <?php echo $translations['tryAgainText']; ?>
</div>
  </div>
</div>
<style>
.default-ltr-cache-zuk9fp, .default-ltr-cache-zuk9fp::after {
    background-color: rgb(216, 157, 49);
}
.default-ltr-cache-zuk9fp {
    font-size: 1rem;
    font-weight: 400;
    border-radius: 0.25rem;
    border-width: 0.0625rem;
...
.default-ltr-cache-1g4mhl1 {
    font-size: 1rem;
    font-weight: 500;
    margin: 0px 0px 0.25rem;
}
.default-ltr-cache-1o3taxu, .default-ltr-cache-1o3taxu:visited {
    color: rgb(0, 0, 0);
}
.default-ltr-cache-1o3taxu {
    border-radius: 0.125rem;
}
.anchor_styles__1h0vwqc0 {
    color: blue;
...
.default-ltr-cache-zuk9fp a, .default-ltr-cache-zuk9fp a:hover, .default-ltr-cache-zuk9fp a:active, .default-ltr-cache-zuk9fp a:visited {
    color: inherit;
    text-decoration: underline;
}
